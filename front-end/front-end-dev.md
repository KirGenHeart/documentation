...
* [main (главная) (4/8)](https://github.com/KirGenHeart/documentation/blob/main/front-end/pages-main-login-register/1.main.md)
* [login (страница входа) (0/2)](https://github.com/KirGenHeart/documentation/blob/main/front-end/pages-main-login-register/2.login.md)
* [register (страница регистрации) (1/3)](https://github.com/KirGenHeart/documentation/blob/main/front-end/pages-main-login-register/3.registration.md)
***

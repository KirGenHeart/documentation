...
### Файловая структура
* `components/main-login-register/header.html`
* `scss/main-login-register/header.scss`
...
### Файловая структура
* `components/main-login-register/footer.html`
* `scss/main-login-register/footer.scss`
